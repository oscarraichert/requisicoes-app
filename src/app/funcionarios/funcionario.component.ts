...
export class FuncionarioComponent implements OnInit {
  ...
  public async salvar(modal: TemplateRef<any>, funcionario?: Funcionario) {
    this.form.reset();
    ...
    try {
      ...
      else this.toastrService.error("O formulário precisa ser preenchido.", "Cadastro de funcionário");
  ...
  public async excluir(funcionario: Funcionario) {
    try {
      ...
      this.toastrService.error(`Houve um erro ao excluir o funcionário. Tente novamente.`, "Cadastro de Funcionários");
    }
  }
